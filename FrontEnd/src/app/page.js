...
export default async function Home() {
  ...
  return (
    <main className='container mx-auto'> 
        ...
        <Image alt='pgimg1' width={300} height={300} className='w-full max-w-xs mx-auto' src='https://i.kym-cdn.com/news/posts/original/000/002/303/cover5.jpg'></Image>
        </div>
 ...
 <nav className="flex justify-center bg-red-800">
  ...
  transition ease-in-out hover:bg-white duration-300 hover:text-black" href="/cardapio"> CARDÁPIO </Link>
        ...
        <div className='border p-4 shadow-xl rounded mb-10' key={produtos.id}>
          <Image alt='pgimg2' width={300} height={300} className='w-full h-auto mb-4' src={produtos.imagem}></Image>
